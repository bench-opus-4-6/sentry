...
class DynamicSamplingOrgConfigurationTest(TestCase):
    def test_subscription_backed_org_uses_blended_sample_rate(self) -> None:
        ...
        assert configuration.version == DynamicSamplingVersion.DynamicSampling
        assert configuration.is_classic_dynamic_sampling
        assert not configuration.is_custom_dynamic_sampling
    ...
    def test_org_mode_custom_dynamic_sampling_uses_org_target_sample_rate(self) -> None:
        ...
        assert configuration.is_enabled
        assert configuration.version == DynamicSamplingVersion.CustomDynamicSampling
        assert configuration.is_custom_dynamic_sampling
        assert not configuration.is_classic_dynamic_sampling
        assert configuration.is_organization_mode
        assert not configuration.is_project_mode
